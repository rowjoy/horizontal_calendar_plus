...
import 'package:horizontal_calendar_plus/src/h_calender_enum.dart';
...
class PackageCore extends CorePlus {
  ...
  PackageCore({required this.builderIndex, required this.dateTime, required this.countPreviesDate, this.changelanguage = Changelanguage.DEFAULT});
